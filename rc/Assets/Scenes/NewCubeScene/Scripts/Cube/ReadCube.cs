...
public class ReadCube : MonoBehaviour
{
    ...
    void SetRayTransforms()
    {
        ...
        //downRays = BuildRays(tUp, new Vector3(90, 90, 0));
        //upRays = BuildRays(tUp, new Vector3(270, 90, 0));
        //backRays = BuildRays(tUp, new Vector3(0, 180, 0));
        //frontRays = BuildRays(tUp, new Vector3(0, 0, 0));
        //leftRays = BuildRays(tUp, new Vector3(0, 90, 0));
        //rightRays = BuildRays(tUp, new Vector3(0, 270, 0));
    }
